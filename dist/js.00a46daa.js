...
var spinner = function spinner() {
  ...
  document.body.appendChild(opacity); // create the container

  var wrapper = document.createElement("div");
  wrapper.classList.add("wrapper", "move-towards-left");
  document.body.appendChild(wrapper); // create the row
  ...
  var wheelOutlineImg = document.createElement("img");
  ...
  spinnerContainer.appendChild(marker); // second column content
  ...
  h3.classList.add("text-left", "text-light", "text-uppercase", "font-weight-bold", "text-justify");
  content.appendChild(h3);
  var h3Text = document.createTextNode("WE HAVE A BONUS FOR EACH ONE OF YOU!");
  ...
  var h6Text = document.createTextNode("Try your luck on our coupon wheel for some exciting offers!");
  ...
  submitButton.classList.add("btn", "btn-light", "text-uppercase", "text-center", "btn-lg");
  submitButton.style.width = "100%";
  var submitBtnText = document.createTextNode("SPIN THE WHEEL");
  ...
  var footerText1 = document.createTextNode("70% offers have been claimed, spin the wheel now to claim yours!");
  ...
  var footer2Text = document.createTextNode("Rules");
  footer2.appendChild(footer2Text);
  content.appendChild(footer2);
  var footer3 = document.createElement("p");
  footer3.classList.add("mb-0", "mt-0", "text-light");
  footer3.style.lineHeight = 1;
  var footer3Text1 = document.createTextNode("- One spin per customer");
  var footer3Text2 = document.createTextNode("- No cheating allowed");
  ...
  form.addEventListener("submit", function (event) {
    ...
    _axios.default.post("http://127.0.0.1:8000/spinner/".concat(name.value, "/").concat(email.value, "/").concat(contact.value)).then(function (response) {
